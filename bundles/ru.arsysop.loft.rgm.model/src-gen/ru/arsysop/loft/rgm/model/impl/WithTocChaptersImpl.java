 ...
 * </p>
 * <ul>
 *   <li>{@link ru.arsysop.loft.rgm.model.impl.WithTocChaptersImpl#getChapters <em>Chapters</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class WithTocChaptersImpl extends MinimalEObjectImpl.Container implements WithTocChapters {
	...
	protected EClass eStaticClass() {
		return RgmPackage.eINSTANCE.getWithTocChapters();
	}
	...
	public EList<TocChapter> getChapters() {
		if (chapters == null) {
			chapters = new EObjectContainmentEList<TocChapter>(TocChapter.class, this, RgmPackage.WITH_TOC_CHAPTERS__CHAPTERS);
		}
		return chapters;
	}
