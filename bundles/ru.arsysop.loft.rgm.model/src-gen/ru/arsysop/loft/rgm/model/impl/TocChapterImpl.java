 ...
 * </p>
 * <ul>
 *   <li>{@link ru.arsysop.loft.rgm.model.impl.TocChapterImpl#getChapters <em>Chapters</em>}</li>
 *   <li>{@link ru.arsysop.loft.rgm.model.impl.TocChapterImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link ru.arsysop.loft.rgm.model.impl.TocChapterImpl#getPart <em>Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TocChapterImpl extends PartImpl implements TocChapter {
	...
	protected EClass eStaticClass() {
		return RgmPackage.eINSTANCE.getTocChapter();
	}
	...
	public EList<TocChapter> getChapters() {
		if (chapters == null) {
			chapters = new EObjectContainmentEList<TocChapter>(TocChapter.class, this, RgmPackage.TOC_CHAPTER__CHAPTERS);
		}
		return chapters;
	}
	...
	public void setNumber(String newNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RgmPackage.TOC_CHAPTER__NUMBER, oldNumber, number));
	}
	...
	public Part getPart() {
		if (part != null && part.eIsProxy()) {
			...
			if (part != oldPart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RgmPackage.TOC_CHAPTER__PART, oldPart, part));
			}
		}
		return part;
	}
	...
	public void setPart(Part newPart) {
		...
		part = newPart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RgmPackage.TOC_CHAPTER__PART, oldPart, part));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RgmPackage.TOC_CHAPTER__NUMBER:
				return getNumber();
			case RgmPackage.TOC_CHAPTER__PART:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == WithTocChapters.class) {
			switch (derivedFeatureID) {
				case RgmPackage.TOC_CHAPTER__CHAPTERS: return RgmPackage.WITH_TOC_CHAPTERS__CHAPTERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == WithTocChapters.class) {
			switch (baseFeatureID) {
				case RgmPackage.WITH_TOC_CHAPTERS__CHAPTERS: return RgmPackage.TOC_CHAPTER__CHAPTERS;
				default: return -1;
			}
		}
