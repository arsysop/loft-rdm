 ...
 * </p>
 * <ul>
 *   <li>{@link ru.arsysop.loft.rgm.model.impl.IndexImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IndexImpl extends PartImpl implements Index {
	...
	protected EClass eStaticClass() {
		return RgmPackage.eINSTANCE.getIndex();
	}
	...
	public EList<IndexEntry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentEList<IndexEntry>(IndexEntry.class, this, RgmPackage.INDEX__ENTRIES);
		}
		return entries;
	}
