 ...
 * </p>
 * <ul>
 *   <li>{@link ru.arsysop.loft.rgm.model.impl.WithPartsImpl#getParts <em>Parts</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class WithPartsImpl extends PartImpl implements WithParts {
	...
	protected EClass eStaticClass() {
		return RgmPackage.eINSTANCE.getWithParts();
	}
	...
	public EList<Part> getParts() {
		if (parts == null) {
			parts = new EObjectContainmentEList<Part>(Part.class, this, RgmPackage.WITH_PARTS__PARTS);
		}
		return parts;
	}
