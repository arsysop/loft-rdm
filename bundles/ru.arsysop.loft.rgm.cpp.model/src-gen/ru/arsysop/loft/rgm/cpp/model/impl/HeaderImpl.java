 ...
 * </p>
 * <ul>
 *   <li>{@link ru.arsysop.loft.rgm.cpp.model.impl.HeaderImpl#getName <em>Name</em>}</li>
 *   <li>{@link ru.arsysop.loft.rgm.cpp.model.impl.HeaderImpl#getSynopsis <em>Synopsis</em>}</li>
 *   <li>{@link ru.arsysop.loft.rgm.cpp.model.impl.HeaderImpl#getDeclarations <em>Declarations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HeaderImpl extends MinimalEObjectImpl.Container implements Header {
	...
	protected EClass eStaticClass() {
		return CppPackage.eINSTANCE.getHeader();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CppPackage.HEADER__NAME, oldName, name));
	}
	...
	public Part getSynopsis() {
		if (synopsis != null && synopsis.eIsProxy()) {
			...
			if (synopsis != oldSynopsis) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CppPackage.HEADER__SYNOPSIS, oldSynopsis, synopsis));
			}
		}
		return synopsis;
	}
	...
	public void setSynopsis(Part newSynopsis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CppPackage.HEADER__SYNOPSIS, oldSynopsis, synopsis));
	}
	...
	public EList<Declaration> getDeclarations() {
		if (declarations == null) {
			declarations = new EObjectContainmentEList<Declaration>(Declaration.class, this, CppPackage.HEADER__DECLARATIONS);
		}
		return declarations;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CppPackage.HEADER__NAME:
				return getName();
			case CppPackage.HEADER__SYNOPSIS:
