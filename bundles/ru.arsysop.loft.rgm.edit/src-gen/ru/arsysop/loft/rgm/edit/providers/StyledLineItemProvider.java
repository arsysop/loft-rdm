...
/**
 * This is the item provider adapter for a {@link ru.arsysop.loft.rgm.model.api.StyledLine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StyledLineItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StyledLine_text_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_StyledLine_text_feature", "_UI_StyledLine_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 RgmPackage.eINSTANCE.getStyledLine_Text(),
				 true,
				 false,
				 false,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StyledLine.class)) {
