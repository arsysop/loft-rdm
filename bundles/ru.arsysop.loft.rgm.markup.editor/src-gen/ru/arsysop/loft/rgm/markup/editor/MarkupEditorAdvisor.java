 ...
 * @generated
 */
public final class MarkupEditorAdvisor extends WorkbenchAdvisor {
	/**
	 ...
	 * @generated
	 */
	private static final String[] FILE_EXTENSION_FILTERS = MarkupEditor.FILE_EXTENSION_FILTERS.toArray(new String[0]); 
	...
	private static String getString(String key, Object s1) {
		return ru.arsysop.loft.rgm.markup.editor.MarkupEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
	...
	public static class Application implements IApplication {
		...
		public Object start(IApplicationContext context) throws Exception {
			WorkbenchAdvisor workbenchAdvisor = new MarkupEditorAdvisor();
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "ru.arsysop.loft.rgm.markup.editor.MarkupEditorAdvisorPerspective"; //$NON-NLS-1$
	...
	/**
	 * Open action for the objects from the Markup model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the Markup model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
