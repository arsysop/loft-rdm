 ...
 * </p>
 * <ul>
 *   <li>{@link ru.arsysop.loft.rgm.spec.model.api.Toc#getDocument <em>Document</em>}</li>
 * </ul>
 *
 * @see ru.arsysop.loft.rgm.spec.model.meta.SpecPackage#getToc()
 * @model
 * @generated
 */
public interface Toc extends WithTocChapters {
	 ...
	 * It is bidirectional and its opposite is '{@link ru.arsysop.loft.rgm.spec.model.api.Document#getToc <em>Toc</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Document</em>' container reference.
	 * @see #setDocument(Document)
	 * @see ru.arsysop.loft.rgm.spec.model.meta.SpecPackage#getToc_Document()
	...
	/**
	 * Sets the value of the '{@link ru.arsysop.loft.rgm.spec.model.api.Toc#getDocument <em>Document</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
