 ...
 * </p>
 * <ul>
 *   <li>{@link ru.arsysop.loft.rgm.spec.model.api.WithTocChapters#getChapters <em>Chapters</em>}</li>
 * </ul>
 *
 * @see ru.arsysop.loft.rgm.spec.model.meta.SpecPackage#getWithTocChapters()
 * @model abstract="true"
 * @generated
 */
public interface WithTocChapters extends EObject {
	 ...
	 * The list contents are of type {@link ru.arsysop.loft.rgm.spec.model.api.TocChapter}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Chapters</em>' containment reference list.
	 * @see ru.arsysop.loft.rgm.spec.model.meta.SpecPackage#getWithTocChapters_Chapters()
