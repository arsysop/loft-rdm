 ...
 * </p>
 * <ul>
 *   <li>{@link ru.arsysop.loft.rgm.spec.model.impl.TableRowImpl#getReferences <em>References</em>}</li>
...
public class TableRowImpl extends PartImpl implements TableRow {
	...
	protected EClass eStaticClass() {
		return SpecPackage.eINSTANCE.getTableRow();
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SpecPackage.TABLE_ROW__REFERENCES:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == WithReferences.class) {
			switch (derivedFeatureID) {
				case SpecPackage.TABLE_ROW__REFERENCES: return SpecPackage.WITH_REFERENCES__REFERENCES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == WithReferences.class) {
			switch (baseFeatureID) {
				case SpecPackage.WITH_REFERENCES__REFERENCES: return SpecPackage.TABLE_ROW__REFERENCES;
				default: return -1;
			}
		}
