 ...
 * </p>
 * <ul>
 *   <li>{@link ru.arsysop.loft.rgm.spec.model.api.StyledLine#getText <em>Text</em>}</li>
 * </ul>
 *
 * @see ru.arsysop.loft.rgm.spec.model.meta.SpecPackage#getStyledLine()
 * @model
 * @generated
 */
public interface StyledLine extends EObject {
	 ...
	 * The list contents are of type {@link ru.arsysop.loft.rgm.spec.model.api.StyledNode}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Text</em>' containment reference list.
	 * @see ru.arsysop.loft.rgm.spec.model.meta.SpecPackage#getStyledLine_Text()
