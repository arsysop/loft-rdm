 ...
 * </p>
 * <ul>
 *   <li>{@link ru.arsysop.loft.rgm.synopsis.model.impl.NamespaceSynopsisImpl#getDefinitions <em>Definitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamespaceSynopsisImpl extends DefinitionSynopsisImpl implements NamespaceSynopsis {
	/**
	 ...
	 * @generated
	 */
	protected NamespaceSynopsisImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SynopsisPackage.eINSTANCE.getNamespaceSynopsis();
	}
	...
	public EList<DefinitionSynopsis> getDefinitions() {
		if (definitions == null) {
			definitions = new EObjectContainmentEList<DefinitionSynopsis>(DefinitionSynopsis.class, this, SynopsisPackage.NAMESPACE_SYNOPSIS__DEFINITIONS);
		}
		return definitions;
	}
