...
/**
 * This is the item provider adapter for a {@link ru.arsysop.loft.rgm.markup.model.api.Tag} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TagItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tag_requirements_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Tag_requirements_feature", "_UI_Tag_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 MarkupPackage.eINSTANCE.getTag_Requirements(),
				 true,
				 false,
				 true,
				 null,
	...
	protected void addContractsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tag_contracts_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Tag_contracts_feature", "_UI_Tag_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 MarkupPackage.eINSTANCE.getTag_Contracts(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MarkupPackage.eINSTANCE.getTag_Id(),
				 true,
				 false,
				 false,
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			...
			styledLabel.append(getString("_UI_Tag_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label); //$NON-NLS-1$ //$NON-NLS-2$
		}
		return styledLabel;
	}
