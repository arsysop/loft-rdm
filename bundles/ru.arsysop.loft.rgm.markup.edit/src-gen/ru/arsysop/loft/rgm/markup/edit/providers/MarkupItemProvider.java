...
/**
 * This is the item provider adapter for a {@link ru.arsysop.loft.rgm.markup.model.api.Markup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MarkupItemProvider 
	 ...
	 * @generated
	 */
	public MarkupItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MarkupPackage.eINSTANCE.getMarkup_Citations());
			childrenFeatures.add(MarkupPackage.eINSTANCE.getMarkup_Requirements());
			childrenFeatures.add(MarkupPackage.eINSTANCE.getMarkup_Tags());
			childrenFeatures.add(MarkupPackage.eINSTANCE.getMarkup_Contracts());
		}
	...
	public Object getStyledText(Object object) {
		return new StyledString(getString("_UI_Markup_type")); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MarkupPackage.eINSTANCE.getMarkup_Citations(),
				 MarkupFactory.eINSTANCE.createCitation()));
		...
		newChildDescriptors.add
			(createChildParameter
				(MarkupPackage.eINSTANCE.getMarkup_Tags(),
				 MarkupFactory.eINSTANCE.createTag()));

		newChildDescriptors.add
			(createChildParameter
				(MarkupPackage.eINSTANCE.getMarkup_Contracts(),
				 MarkupFactory.eINSTANCE.createContract()));
	}
