...
public class ContractImpl extends MinimalEObjectImpl.Container implements Contract {
	...
	protected EClass eStaticClass() {
		return MarkupPackage.eINSTANCE.getContract();
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MarkupPackage.CONTRACT__ID, oldId, id));
	}
	...
	public EList<Tag> getTags() {
		if (tags == null) {
			tags = new EObjectWithInverseResolvingEList.ManyInverse<Tag>(Tag.class, this, MarkupPackage.CONTRACT__TAGS, MarkupPackage.TAG__CONTRACTS);
		}
		return tags;
	}
